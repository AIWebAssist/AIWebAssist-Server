...
def test_screenshot_changed():
    ...
    screen_strem_before = file_to_bytes(
        os.path.join(resources, "step_1_screenshot.png")
    )
    screen_strem_current = file_to_bytes(
        os.path.join(resources, "step_2_screenshot.png")
    )
