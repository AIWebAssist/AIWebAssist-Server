...
def simulate(experiment_uuid,url,task_description,max_num_of_iteration):
    ...
    simulate_client_click(url,task_description,experiment_uuid,num_of_iteration=max_num_of_iteration)
    # stop the server
    stop_server()


scenarios = [
    {"url":"https://www.google.com/?hl=en","task_description":"I need to search my name in google, my name is 'sefi'","max_num_of_iteration":10},
